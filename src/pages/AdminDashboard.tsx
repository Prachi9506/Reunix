  ...
  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-transform duration-200 hover:scale-105">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className={`text-sm font-medium ${change.startsWith('+') ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
...
const AdminDashboard: React.FC = () => {
  ...
  const chartOptions = {
    ...
    scales: {
      x: { ticks: { color: '#1f2937', }, grid: { color: '#d1d5db' } },
      y: { ticks: { color: '#1f2937', }, grid: { color: '#d1d5db' } },
    },
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <div className="h-64">
                <Pie data={deptChartData} options={{ ...chartOptions, plugins: { legend: { position: 'bottom', labels: { color: '#fff' } } } }} />
              </div>
            </div>
