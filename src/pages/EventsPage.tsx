  ...
  const events = [
    {
      ...
      description: 'Learn from scratch React patterns and best practices from industry experts.',
      date: 'September 15, 2025',
      time: '5:00 PM onwards',
      location: 'E-Block, Room 101',
      host: 'CPByte Team',
      hostAvatar: 'https://avatars.githubusercontent.com/u/223275693?s=200&v=4',
      participants: 74,
      maxParticipants: 100,
      type: 'Bootcamp',
      category: 'Technical',
    ...
    },
    {
      ...
      host: 'CRPC Team',
      hostAvatar: 'https://yt3.googleusercontent.com/pC5_Aeah5RiP2aJFZpTr79onEas67Fva9DCEPhRZj3pTtRCTm-jYKwGo5gK9y1acIcPVVURCJw=s160-c-k-c0x00ffffff-no-rj',
      participants: 182,
      maxParticipants: 500,
      type: 'Career Talk & placement guidance',
      category: 'Career',
      status: 'upcoming',
      tags: ['Career', 'Interview', 'FAANG','Alumini Meetup', 'Networking']
    },
    {
      id: 3,
      title: 'SIH 25: Deptartmental level Hackathon',
      description: 'A gateway to the most prestigous National level hackathon of India',
      ...
      category: 'Technical',
      status: 'upcoming',
      tags: ['Hackathon', 'Innovation', 'Competition','Project']
    }
  ];
